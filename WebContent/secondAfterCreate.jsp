...
<%--Creates the student row in database. --%>
...
String query1 = "select S.ruid from Student S where S.ruid ='"+ ruid+"'";
...
if(i == 0){
	 PreparedStatement ps2 = con
	           .prepareStatement("INSERT INTO Student(ruid, netid, pwd, gpa, credits, major) VALUES ('" + ruid + "','"+netid+ "','" + password + "','" + gpa + "','" + credits + "','" + major +"');");
