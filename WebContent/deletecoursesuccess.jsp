...
<%--Delete's section a professor is teaching from the database. --%>
...
PreparedStatement ps = con.prepareStatement("DELETE FROM Section  WHERE Section.cid = '" +cid+ "' AND Section.sec_id = '" + section+ "';");
ps.executeUpdate();
